...
function isAgeValid() {
  var birthDate = (0, _moment2["default"])($('#year').val() + '-' + $('#month').val() + '-' + $('#day').val());
  return (0, _moment2["default"])().diff(birthDate, 'years') >= 18;
}
...
/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["$"] = __webpack_require__(131);
